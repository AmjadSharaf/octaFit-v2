...
class OnboardingScreen extends StatefulWidget {
  ...
  static int pageFromPath(String path) {
    if (path == AppRouters.onboarding2) return 1;
    if (path == AppRouters.onboarding3) return 2;
    if (path == AppRouters.onboarding4) return 3;
    if (path == AppRouters.onboarding5) return 4;
    return 0;
  }
